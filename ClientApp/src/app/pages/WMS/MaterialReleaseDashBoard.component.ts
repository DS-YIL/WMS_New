...
@Component({
  ...
  templateUrl: './MaterialReleaseDashBoard.component.html'
})
export class MaterialReleaseDashBoardComponent implements OnInit {
  ...
  public materialreleaseList: Array<any> = [];
  ...
  getMaterialIssueList() {
    ...
    this.wmsService.GetreleasedMaterilalist(this.employee.employeeno).subscribe(data => {
      this.materialreleaseList = data;    
    });
  }
}

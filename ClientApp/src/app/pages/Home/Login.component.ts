...
export class LoginComponent implements OnInit {
  ...
  getRoles() {
    ...
    this.dynamicData.query = "select * from wms.rolemaster order by roleid";
  ...
  bindMenu() {
    ...
    if (this.employee.roleid == "7") {//admin
      MENU_ITEMS[6].hidden = MENU_ITEMS[7].hidden = MENU_ITEMS[8].hidden = MENU_ITEMS[9].hidden = MENU_ITEMS[10].hidden = MENU_ITEMS[11].hidden = MENU_ITEMS[12].hidden = MENU_ITEMS[13].hidden = MENU_ITEMS[14].hidden = MENU_ITEMS[15].hidden = MENU_ITEMS[16].hidden = MENU_ITEMS[17].hidden=false;

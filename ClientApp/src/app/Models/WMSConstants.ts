...
export class constants {
  ...
  public ItemId: searchParams = { tableName: 'wms.v_getmateraildetails', fieldId: 'materialid', fieldName: 'materialdescription', condition: " where ", fieldAliasName: "", updateColumns: "" };

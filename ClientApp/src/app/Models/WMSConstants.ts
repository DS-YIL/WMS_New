...
export class constants {
  ...
  public ItemId: searchParams = { tableName: 'wms.MaterialMasterYGS', fieldId: 'Material', fieldName: 'Materialdescription', condition: " where ", fieldAliasName: "", updateColumns: "" };
